...
\begin{itemize}
    ...
    \item Whether the coordinates of any piston become desynchronized between control volumes on either side of the mentioned piston. (\texttt{run} subroutine return code 9) % chktex 12
\end{itemize}
