...
\begin{align}
    ...
    &\qquad+ (3 - 3 \alpha_{0,i \rightarrow j} - 2 \dot{\alpha}_{0,i \rightarrow j}) \, {\left(\frac{t}{t_{\text{opening},i \rightarrow j}}\right)}^2 \nonumber \\
    &\qquad - (2 - 2 \alpha_{0,i \rightarrow j} - \dot{\alpha}_{0,i \rightarrow j}) \, {\left(\frac{t}{t_{\text{opening},i \rightarrow j}}\right)}^3
\end{align}
