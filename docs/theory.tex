...
\textbf{BlasterSim does not use this model} because it is not smooth, and smooth functions are useful for automatic differentiation (see~\secref{autodiff}) and beneficial for numerical stability.
