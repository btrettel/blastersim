...
\label{compiling-from-source-tarball}
...
\subsection{Compiling BlasterSim releases}
...
\subsection{Compiling BlasterSim documentation}
\label{compiling-docs}
