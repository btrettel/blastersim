...
The control volume index for the barrel is \texttt{I_BARREL}, which is set to 1. This convention allows BlasterSim to easily know which control volume is the barrel.
