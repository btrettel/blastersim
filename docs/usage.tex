...
\begin{itemize}
    \item \texttt{x} ($x_i - x_{\text{min},i}$): Location of the projectile/plunger.
    More specifically, the distance between the projectile/plunger and the minimum limit of the motion of the projectile/plunger (for example, the end of the plunger tube). % or the projectile's starting location).
    Floating-point number.
    Units of m.
