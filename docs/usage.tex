...
\begin{itemize}
\item If the flow rate is too high (typically through making \texttt{d\_e} too large), BlasterSim can become unstable and produce inaccurate results.
This problem can be solved at the moment by making the time step (\texttt{dt}) small enough that the instability disappears, however, this can make running BlasterSim slow.
