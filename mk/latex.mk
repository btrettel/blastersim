...
TEX_DEPS = docs$(DIR_SEP)usage.tex docs$(DIR_SEP)theory.tex docs$(DIR_SEP)verval.tex docs$(DIR_SEP)dev.tex docs$(DIR_SEP)rev.tex docs$(DIR_SEP)test_exact.tex docs$(DIR_SEP)geninput_springer.tex

CLEAN_TEX = docs$(DIR_SEP)*.aux docs$(DIR_SEP)*.bbl docs$(DIR_SEP)*.blg docs$(DIR_SEP)*.css docs$(DIR_SEP)*.html docs$(DIR_SEP)*.log docs$(DIR_SEP)*.out docs$(DIR_SEP)*.toc docs$(DIR_SEP)$(TEX_KEY)_bibertool.bib
